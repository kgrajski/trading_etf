...
# MAGIC %pip install langgraph langchain-openai langchain-google-genai tavily-python mlflow -q
...
# Load candidates table from catalog
candidates_spark_df = spark.table("workspace.default.candidates")
df = candidates_spark_df.toPandas()
candidates = df.to_dict(orient="records")

print(f"Loaded {len(candidates)} candidates from workspace.default.candidates")
